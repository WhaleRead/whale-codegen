...
public class SooRepository extends NamedParameterJdbcDaoSupport {
    ...
    public int countByCriteria(Criteria criteria) {
        ...
        return getNamedParameterJdbcTemplate().queryForObject("SELECT COUNT(0) FROM " + Soo.TABLE_NAME + " s " + criteria.getWhereClause(), params, int.class);
    }

    @Generated(value="com.whaleread.codegen.api.WhaleGenerator")
    public List<Soo> selectByCriteria(Criteria criteria, int offset, int count) {
        Map<String, Object> params = criteria.toSql();
        return getNamedParameterJdbcTemplate().query("SELECT " + Soo.ALIASED_BASE_COLUMNS + " FROM " + Soo.TABLE_NAME + " s " + criteria.getWhereClause() + criteria.getOrderByClause() + " LIMIT " + offset + ',' + count, params, rowMapper);
    }
    ...
    public void deleteByCriteria(Criteria criteria) {
        Map<String, Object> params = criteria.toSql();
        getNamedParameterJdbcTemplate().update("DELETE FROM " + Soo.TABLE_NAME + ' ' + criteria.getWhereClause(), params);
    }
}