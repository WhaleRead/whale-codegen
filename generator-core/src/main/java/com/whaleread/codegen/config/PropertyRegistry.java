...
public class PropertyRegistry {
    ...
    public static final String TABLE_SHARDING_TABLE_NAME = "shardingTableName";
    public static final String TABLE_SHARDING_PARAMS = "shardingParams";
...
//    public static final String DAO_METHOD_NAME_CALCULATOR = "methodNameCalculator"; //$NON-NLS-1$
    ...
    public static final String COMMENT_GENERATOR_NAME = "name";
}
