...
public class VirtualPrimaryKeyPlugin extends PluginAdapter {
    ...
    /* (non-Javadoc)
     * @see com.whaleread.codegen.api.Plugin#validate(java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.whaleread.codegen.api.PluginAdapter#initialized(com.whaleread.codegen.api.IntrospectedTable)
     */
    @Override
