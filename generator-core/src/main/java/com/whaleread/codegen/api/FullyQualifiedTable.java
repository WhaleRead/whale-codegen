...
import com.whaleread.codegen.config.DomainObjectRenamingRule;
import com.whaleread.codegen.internal.util.JavaBeansUtil;
...
import static com.whaleread.codegen.internal.util.JavaBeansUtil.getCamelCaseString;
...
public class FullyQualifiedTable {
     ...
     * table.
     *
     * @param introspectedCatalog       the actual catalog of the table as returned from DatabaseMetaData. This value
     ...
     *                                  generated code.
     * @param introspectedSchema        the actual schema of the table as returned from DatabaseMetaData. This value
     ...
     * @param domainObjectRenamingRule  If domainObjectName is not configured, we'll build the domain object named based on the tableName or runtimeTableName.
    ...
    public String getDomainObjectProperty() {
    ...
    public String getSubPackageForModel(boolean isSubPackagesEnabled) {
        StringBuilder sb = new StringBuilder();
        sb.append(getSubPackage(isSubPackagesEnabled));
