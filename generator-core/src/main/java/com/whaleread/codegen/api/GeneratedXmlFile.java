...
import com.whaleread.codegen.internal.XmlFileMergerJaxp;
...
public class GeneratedXmlFile extends GeneratedFile {
    ...
    /* (non-Javadoc)
     * @see com.whaleread.codegen.api.GeneratedFile#isMergeable()
     */
    @Override
    ...
    @Override
    public String merge(File existingFile) throws ShellException {
        try {
            return XmlFileMergerJaxp.getMergedSource(new InputSource(new StringReader(getFormattedContent())),
