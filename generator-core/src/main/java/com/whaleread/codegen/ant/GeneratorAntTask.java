 ...
 */
package com.whaleread.codegen.ant;
 ...
 *               classname="com.whaleread.codegen.ant.GeneratorAntTask"
...
public class GeneratorAntTask extends Task {
    ...
    public void execute() throws BuildException {
        ...
        try {
            ...
            WhaleGenerator generator = new WhaleGenerator(config, callback, warnings);

            generator.generate(new AntProgressCallback(this, verbose), contexts,
