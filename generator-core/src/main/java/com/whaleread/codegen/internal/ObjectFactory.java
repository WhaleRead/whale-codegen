...
import com.whaleread.codegen.api.ddl.DdlConnectionFactory;
import com.whaleread.codegen.api.dom.DefaultJavaFormatter;
import com.whaleread.codegen.api.dom.DefaultXmlFormatter;
import com.whaleread.codegen.config.*;
import com.whaleread.codegen.internal.types.JavaTypeResolverDefaultImpl;
...
public class ObjectFactory {
    ...
    public static ConnectionFactory createConnectionFactory(Context context) {
        ...
        }else if(config.getConfigurationType().equals("DDL")) {
            type = DdlConnectionFactory.class.getName();
        } else {
            type = config.getConfigurationType();
        }
    ...
    public static IntrospectedTable createIntrospectedTableForValidation(Context context) {
        IntrospectedTable answer = (IntrospectedTable) createInternalObject(IntrospectedTableWhaleImpl.class.getName());
        answer.setContext(context);
