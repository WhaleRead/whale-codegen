 ...
 */
package com.whaleread.codegen.internal.util;
...
public class JavaBeansUtil {
    ...
    public static void publicStaticFinal(JavaElement element) {
        element.setVisibility(JavaVisibility.PUBLIC);
        element.setStatic(true);
        element.setFinal(true);
    }

    public static void privateStaticFinal(JavaElement element) {
