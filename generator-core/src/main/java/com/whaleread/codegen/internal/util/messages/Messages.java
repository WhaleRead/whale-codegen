 ...
 */
package com.whaleread.codegen.internal.util.messages;
...
public class Messages {
    private static final String BUNDLE_NAME = "com.whaleread.codegen.internal.util.messages.messages"; //$NON-NLS-1$
